...
const Homepage = () => {
  ...
  return (
    ...
    <div className='my-body'>
      ...
      <div className='my-widthchk' style={{alignContent:"center",width:"60vw", margin:"0 auto"}}>
      <div className="my-container">
        <div className="my-glass" style={{ '--r': -15 }} data-text="Training">
          <span className="material-symbols-outlined" style={{ fontSize: '5em' }}>
            exercise
          </span>
        </div>
        ...
        <div className="row justify-content-center align-items-center vh-100">
            ...
            <div className="card bg-primary text-white shadow-lg p-5 rounded">
                ...
                <div className="col-md-6 text-center">
                    ...
                    <Link className="btn btn-pink text-white" to="/Login">Join us and log your workouts now</Link>
                </div>
                </div>
            </div>
            </div>
